    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F3F4F6] to-white">
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-80 bg-[#0C3D2E] p-6">
            ...
            <div className="space-y-4">
              <Link href="/inicio" className="text-white flex items-center space-x-2 text-lg">
                <TrendingUp /> <span>Inicio</span>
              </Link>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="hidden md:flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-[#0C3D2E]">Inicio</h1>
